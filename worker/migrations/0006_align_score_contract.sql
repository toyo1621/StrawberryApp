CREATE TABLE rankings_score_contract (
  id TEXT PRIMARY KEY,
...
INSERT INTO rankings_score_contract (id, player_name, score, game_type, created_at, owner_hash)
SELECT id, player_name, score, game_type, created_at, owner_hash
FROM rankings;

DROP TABLE rankings;
ALTER TABLE rankings_score_contract RENAME TO rankings;

CREATE INDEX idx_rankings_game_score_created
  ON rankings (game_type, score DESC, created_at ASC);
CREATE INDEX idx_rankings_player_game_created
  ON rankings (player_name, game_type, created_at DESC);
CREATE INDEX idx_rankings_game_player_identity_created
